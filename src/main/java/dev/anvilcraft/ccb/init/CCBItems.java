    ...
    public static final ItemEntry<Item> MUSH_FRY = REGISTRUM
        ...
        .recipe((ctx, provider) -> {
            SimpleCookingRecipeBuilder
                .campfireCooking(
                    Ingredient.of(CCBItems.MUSH_BAR.get()),
                    RecipeCategory.FOOD,
                    ctx.get(),
                    1.0F,
                    600)
                .unlockedBy("has_mush_bar", RegistrumRecipeProvider.has(CCBItems.MUSH_BAR.get()))
                .save(provider, ResourceLocation.fromNamespaceAndPath(AnvilCraftCCB.MOD_ID, "smelting/mush_fry_from_campfire"));
            SimpleCookingRecipeBuilder
                .smoking(
                    Ingredient.of(CCBItems.MUSH_BAR.get()),
                    RecipeCategory.FOOD,
                    ...
                    100)
                .unlockedBy("has_mush_bar", RegistrumRecipeProvider.has(CCBItems.MUSH_BAR.get()))
                .save(provider, ResourceLocation.fromNamespaceAndPath(AnvilCraftCCB.MOD_ID, "smelting/mush_fry_from_smoker"));
            SimpleCookingRecipeBuilder
                .smelting(
                    Ingredient.of(CCBItems.MUSH_BAR.get()),
                    RecipeCategory.FOOD,
                    ...
                    200)
                .unlockedBy("has_mush_bar", RegistrumRecipeProvider.has(CCBItems.MUSH_BAR.get()))
                .save(provider, ResourceLocation.fromNamespaceAndPath(AnvilCraftCCB.MOD_ID, "smelting/mush_fry_from_furnace"));
        })
        .register();
