...
public class GeneticOoze extends Fluid {
    ...
    public Item getBucket() {
        return CCBItems.GENETIC_OOZE_BUCKET.asItem();
    }
    ...
    protected BlockState createLegacyBlock(FluidState fluidState) {
        return CCBBlocks.GENETIC_OOZE_BLOCK.getDefaultState();
    }
    ...
    public VoxelShape getShape(FluidState fluidState, BlockGetter level, BlockPos pos) {
        return CCBBlocks.GENETIC_OOZE_BLOCK.getDefaultState().getShape(level, pos);
    }

    @Override
    public FluidType getFluidType() {
        return CCBFluids.GENETIC_OOZE_TYPE.get();
    }
}
